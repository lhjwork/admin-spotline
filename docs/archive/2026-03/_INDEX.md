# Archive Index — 2026-03 (admin-spotLine)

| Feature | Match Rate | Iterations | Duration | Archived |
|---------|:----------:|:----------:|----------|----------|
...
### crew-curation-tool (Phase 2A — Quick Spot + Bulk 큐레이션)

| Document | File |
|----------|------|
| Plan | [crew-curation-tool.plan.md](./crew-curation-tool/crew-curation-tool.plan.md) |
| Design | [crew-curation-tool.design.md](./crew-curation-tool/crew-curation-tool.design.md) |
| Analysis | [crew-curation-tool.analysis.md](./crew-curation-tool/crew-curation-tool.analysis.md) |
| Report | [crew-curation-tool.report.md](./crew-curation-tool/crew-curation-tool.report.md) |

### crew-curation-tool-2b (Phase 2B — Route Builder UX 개선)

| Document | File |
|----------|------|
| Plan | [crew-curation-tool-2b.plan.md](./crew-curation-tool-2b/crew-curation-tool-2b.plan.md) |
